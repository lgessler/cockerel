...
import { QUERY } from 'src/components/IngredientCategory/IngredientCategoriesCell'
...
const IngredientCategoriesList = ({ ingredientCategories }) => {
        ...
        <tbody>
          {ingredientCategories.map((ingredientCategory) => (
            <tr key={ingredientCategory.id}>
              <td>{truncate(ingredientCategory.id)}</td>
              <td>{truncate(ingredientCategory.name)}</td>
              <td>
                <nav className="rw-table-actions">
                  <Link
                    to={routes.ingredientCategory({
                      id: ingredientCategory.id,
                    })}
                    title={
                      'Show ingredientCategory ' +
                  ...
                  <Link
                    to={routes.editIngredientCategory({
                      id: ingredientCategory.id,
                    })}
                    title={'Edit ingredientCategory ' + ingredientCategory.id}
                  ...
                  <button
                    type="button"
                    title={'Delete ingredientCategory ' + ingredientCategory.id}
